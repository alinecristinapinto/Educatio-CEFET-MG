...
<div class="wrapper">
	...
	<div class="container">
		...
		<form class="contact-form" action="midiasphp.php" method="post">
			<div class="container">
				<div class="row">
	       			...
	       			<div class="col-md-12">
	         			<label class="fonteTexto">Nome:</label>
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nome" placeholder="Nome da midia" required='required'>
								</div>
				      </div>
					</div>
					<div class="col ml-auto mr-auto">
       			<div class="col-md-12">
         			<label class="fonteTexto">Subtipo:</label>
							<div class="input-group">
								...
								<input type="text" class="form-control" name="subtipo" placeholder="Subtipo da midia" required='required'>
							</div>
			      </div>
					</div>	
				</div>
       			...
       			<div class="col-md-12">
         			<label class="fonteTexto">Local:</label>
							<div class="input-group">
								...
								<input type="text" class="form-control" name="local" placeholder="Local da midia" required='required'>
							</div>
			      </div>
					</div>	
				</div>
       			...
       			<div class="col-md-12">
         			<label class="fonteTexto">Editora:</label>
							<div class="input-group">
								...
								<input type="text" class="form-control" name="editora" placeholder="Editora da Midia" required='required'>
							</div>
			      </div>
					</div>	
				</div>
	       			...
	       			<div class="col-md-12">
	         			<label class="fonteTexto">Tempo:</label>
								<div class="input-group">
									...
									<input type="number" class="form-control" name="tempo" placeholder="Tempo da midia" required='required'>
								</div>
				      </div>
					</div>
				</div>
