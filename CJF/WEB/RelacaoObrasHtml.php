...
<body>
	<div class="jumbotron">
  		<h1 class="display-3">Relação de obras emprestadas a devolver</h1>
  		<hr class="my-4">
	</div>

	<div class="container" class="form-group">
		<form method='post' action='Relatorio2.php'>
			<br><label for="entraData">Digite a data de devolucao dos emprestimos ou deixe em branco para gerar um relatório geral:</label>
			<input type='textarea' class="form-control" name='data' aria-describedby="dataAjuda" placeholder="Data de devolução dos emprestimos"><br>
