            ...
            <ul class="nav navbar-nav mr-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../../Entrada/gerencia-web-interface-coordenador.php?acao=transferirAluno">Transferencia</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../../Entrada/gerencia-web-interface-coordenador.php?acao=atualizarAnoAlunos">Atualizar ano dos alunos</a>
                    </ul>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../../Entrada/gerencia-web-interface-coordenador.php?acao=acessarHistoricoAlunos">Acessar historicos de alunos</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href= "../../../Entrada/gerencia-web-interface-coordenador.php?acao=acessarProfessores">Acessar professores</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../../Entrada/gerencia-web-interface-coordenador.php?acao=acessarConteudos">Acessar conteudos de disciplinas</a>
                        <div class="dropdown-divider"></div>
