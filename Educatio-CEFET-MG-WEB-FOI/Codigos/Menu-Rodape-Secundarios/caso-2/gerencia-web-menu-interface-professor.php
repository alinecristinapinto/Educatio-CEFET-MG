	...
	<nav class="navbar navbar-expand-md navbar-default">
        ...
        <div id="menu" class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../../Entrada/gerencia-web-interface-professor.php?acao=acessarDiarios"><i class="nc-icon nc-book-bookmark"></i>Diários</a>
                </li>
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <a class="dropdown-item" href= "../../Entrada/gerencia-web-interface-professor.php?acao=adicionarEtapa">Adicionar etapas</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../Entrada/gerencia-web-interface-professor.php?acao=removerEtapa">Remover etapas</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../../Entrada/gerencia-web-interface-professor.php?acao=alterarEtapa">Alterar etapas</a>                       
                    </ul>
                </div>
            </ul>
            <ul class="nav navbar-nav">
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="../../Entrada/gerencia-web-perfil-professor.php">Perfil</a>
                        <div class="dropdown-divider"></div>
