...
*/
	...
	echo "<h2 class=\"text-center\">".'Situacao de Integridade: Direcao->De cima para baixo'."</h2><br>";		
	if($stringRelatorioErros == null){
		echo "<div class=\"wrapper\">     
            	<div class=\"container\">
                	<div class=\"row\">
                    	<div class=\"col-md-8 ml-auto mr-auto\">
                    		<p class = \"fonteTexto\">Nao existem problemas de integridade no Sistema nesta direcao.</p>
                    	</div>
                    </div>
                </div>
              </div>";
	...
	echo "<h2 class=\"text-center\">".'Situacao de Integridade: Direcao->De baixo para cima'."</h2><br>";
