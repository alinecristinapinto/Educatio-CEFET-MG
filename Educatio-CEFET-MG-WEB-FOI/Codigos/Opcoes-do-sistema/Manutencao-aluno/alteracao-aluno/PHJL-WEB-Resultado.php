	...
	<body>
		...
		<?php
			if(RESULTADO == "inserirSUCESSO"){
				echo '
				<iframe class="TelaCheiaiframe" src="../Opcoes-do-sistema/Manutencao-aluno/insercao-aluno/PHJL-WEB-Formulario-de-insercao-de-aluno.php"></iframe>
				...
				echo '
					<iframe class="TelaCheiaiframe" src="../../../Entrada/gerencia-web-interface-coordenador.php?acao=alterarAluno"></iframe>
				...
				echo '
					<iframe class="TelaCheiaiframe" src="../../../Entrada/gerencia-web-interface-coordenador.php?alterarAluno"></iframe>
