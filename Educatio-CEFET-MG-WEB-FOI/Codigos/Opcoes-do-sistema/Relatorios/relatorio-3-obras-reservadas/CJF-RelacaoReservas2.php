	...
	if ($_POST['data'] == null) {
		...
		if ($arrayDados == null) {
			printf("<div class='alert alert-info' role='alert'>
 					 Nenhuma reserva encontrada nessa data. <a href='../../../Entrada/gerencia-web-interface-bibliotecario.php?acao=acessarObrasReservadas' class='alert-link'>Tentar novamente</a>. 
							</div>
						</div>
					</div>	
				</div>
...
printf("	
	...
	"<div class='alert alert-info' role='alert'>
 					 Nenhuma reserva encontrada! <a href='../../../Entrada/gerencia-web-interface-bibliotecario.php?acao=acessarObrasReservadas' class='alert-link'>Tentar novamente</a>. 
							</div>
						</div>
					</div>	
				</div>
...
exit;
	...
	printf(
	"<div class='alert alert-info' role='alert'>
 					 Erro: Falha na pesquisa. <a href='../../../Entrada/gerencia-web-interface-bibliotecario.php?acao=acessarObrasReservadas' class='alert-link'>Tentar novamente</a>. 
							</div>
						</div>
					</div>	
				</div>
