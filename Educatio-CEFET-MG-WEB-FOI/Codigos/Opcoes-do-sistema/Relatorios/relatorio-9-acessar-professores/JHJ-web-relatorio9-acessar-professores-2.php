...
<html>
    <head>
       ...
       <!-- CSS do Bootstrap -->
        ...
        <link href="JHJ-web-estilos-relatorio9-tabela.css" rel="stylesheet" />
        <link href="JHJ-web-estilos-relatorio9-tabela-filtros.css" rel="stylesheet" />

        <!-- Arquivos js -->
        <script src="../../../../Estaticos/Bootstrap/js/popper.js"></script>
        <script src="../../../../Estaticos/Bootstrap/js/jquery-3.2.1.js" type="text/javascript"></script>
        <script src="../../../../Estaticos/Bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <!-- <script src="JHJ-web-script.js" type="text/javascript"></script> -->
        ...
        <script type="text/javascript">
            ...
            function irParaPaginaDownloadRelatorioAcessarProfessores(){
                location.href = 'JHJ-web-relatorio9-acessar-professores-3.php';
            }
        </script>
    </head>
    <body>
