<html>
	<head>
		...
		<title> Integridade do Sistema </title>
...
*/
	...
	echo "<h2 class=\"text-center\">".'Situação de Integridade: Direção->De cima para baixo'."</h2><br>";		
	if($stringRelatorioErros == null){
		echo "<div class=\"wrapper\">     
            	<div class=\"container\">
                	<div class=\"row\">
                    	<div class=\"col-md-8 ml-auto mr-auto\">
                    		<p class = \"fonteTexto\">Não existem problemas de integridade no Sistema nesta direção.</p>
                    	</div>
                    </div>
                </div>
              </div>";
		...
		echo "<div class=\"wrapper\">     
            	<div class=\"container\">
                	<div class=\"row\">
                    	<div class=\"col-md-8 ml-auto mr-auto\">
                    		<p class = \"fonteTexto\">$stringRelatorioErros</p>
                    	</div>
                    </div>
                </div>
              </div>";
	...
	echo "<h2 class=\"text-center\">".'Situação de Integridade: Direção->De baixo para cima'."</h2><br>";
	if ($stringRelatorioErrosReverso == null){
		echo "<div class=\"wrapper\">     
            	<div class=\"container\">
                	<div class=\"row\">
                    	<div class=\"col-md-8 ml-auto mr-auto\">
		...
		echo "<div class=\"wrapper\">     
            	<div class=\"container\">
                	<div class=\"row\">
                    	<div class=\"col-md-8 ml-auto mr-auto\">
							<p class = \"fonteTexto\">$stringRelatorioErrosReverso</p>
						</div>
                    </div>
                </div>
              </div>";
