...
class midias{
	...
	function alteraLivroAcervo($intIdAcervo, $charNovoISBN, $charNovoEdicao, $intNovoIdCampi, $charNovoNome, $charNovoTipo, $charNovoLocal, $charNovoAno, $charNovoEditora, $charNovoPaginas){
		...
		$sqlAlterandoISBN = "UPDATE academicos SET programa = '$charNovoISBN' WHERE idAcervo = '$intIdAcervo'";
...
$aaa -> alteraLivroAcervo($intIdAcervo,$_POST['programa'],'',$_POST['idCampi'],$_POST['nome'],'academicos',$_POST['local'],$_POST['ano'],$_POST['editora'],$_POST['paginas']);



echo "<script>location.href='../../Entrada/gerencia-web-interface-bibliotecario.php?acao=acessarManutencaoAcervo';</script>";
