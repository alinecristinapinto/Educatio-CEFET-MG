        ...
        if ($conn->query($sql) === TRUE) {
          ...
          echo "<div class=\"row\">
                <div class=\"col-md-4 ml-auto mr-auto\">
                  <button type=\"button\" class=\"btn btn-info\" onclick=\"window.location.href='../../Entrada/gerencia-web-interface-bibliotecario.php?acao=removerEmprestimo'\">Pronto</button>
                </div>
                </div>";
          echo "</div>";
          echo "</div>";
