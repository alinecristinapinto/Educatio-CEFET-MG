...
<head>
	...
	<script type="text/javascript">
		function func1(){
			window.location.href="../Opcoes-do-sistema/Manutencao-professores/form_professor.php"
		}
		function enviaFormulario(valor){
			...
			function escreveNomes(str){
				...
				if (str.length == 0){
					...
					xmlhttp.open("GET", "../Opcoes-do-sistema/Manutencao-professores/tabela-descarte.php?q=mostrar" + "&depto=" + valor, true);
					xmlhttp.send();
				}
			}''
			...
			function mostraAlunos(str, tipo) {
				...
				if (str.length == 0) { 
					...
					xmlhttp.open("GET", "../Opcoes-do-sistema/Manutencao-professores/tabela-descarte.php?q=" + str + "&tipo=" + tipo + "&depto=" + valor, true);
					xmlhttp.send();
				}
			}
...
function retornaValores(inputid, valor, id){
	...
	xmlhttp.open("GET", "../Opcoes-do-sistema/Manutencao-professores/PHJL-WEB-Retorna-valor-dos-selects.php?valor=" + valor + "&id=" +id , true);
	xmlhttp.send();
