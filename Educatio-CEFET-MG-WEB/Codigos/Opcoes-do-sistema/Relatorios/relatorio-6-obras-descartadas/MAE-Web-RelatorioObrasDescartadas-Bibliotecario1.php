                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <h2 class="text-center">Relatorio de obras descartadas</h2>

                            <form class="contact-form" action="../Opcoes-do-sistema/Relatorios/relatorio-6-obras-descartadas/MAE-Web-RelatorioObrasDescartadas-Bibliotecario2.php" method="POST">
                                <div class="row">
