...
<html>
	<head>
		...
		<!-- CSS -->
		<link rel="stylesheet" type="text/css" href="../Opcoes-do-sistema/alteracao-aluno/PHJL-WEB-Estilo-paginas.css"> 
		...
		<script type="text/javascript">
			...
			function mostraAlunos() {
				...
				xmlhttp.open("GET", "../Opcoes-do-sistema/alteracao-aluno/PHJL-WEB-Procura-alunos.php?q=" + str + "&tipo=" + tipoInput + "&valorfiltro=" + valorFiltro + "&tipofiltro=" + tipoFiltro, true);
				xmlhttp.send();
			}
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 ml-auto mr-auto">
							...
							<form class="contact-form" method = "POST" action = "../Opcoes-do-sistema/alteracao-aluno/PHJL-WEB-Formulario-de-alteracao-de-aluno.php" id="formulario">
								<div class = "row">
