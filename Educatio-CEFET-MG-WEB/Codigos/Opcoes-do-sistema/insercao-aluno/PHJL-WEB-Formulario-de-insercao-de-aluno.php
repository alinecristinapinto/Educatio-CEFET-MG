...
<html>
	...
	<head>
		...
		<!-- CSS -->       
		<link rel="stylesheet" type="text/css" href="../Opcoes-do-sistema/insercao-aluno/PHJL-WEB-Estilo-paginas.css">
        ...
        <script type="text/javascript">
            ...
            function retornaValores(inputid, valor, id){
                ...
                xmlhttp.open("GET", "../Opcoes-do-sistema/insercao-aluno/PHJL-WEB-Retorna-valor-dos-selects.php?valor=" + valor + "&id=" +id , true);
                xmlhttp.send();
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto">
                        ...
                        <form class="contact-form" method = "POST" action = "../Opcoes-do-sistema/insercao-aluno/PHJL-WEB-Insercao-de-aluno-no-BD.php" id= "formulario" 
