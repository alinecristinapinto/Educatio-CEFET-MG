...
<html>
	<head>
		...
		<!-- CSS do Bootstrap -->
		<link rel="stylesheet" type="text/css" href="../Opcoes-do-sistema/remocao-aluno/PHJL-WEB-Estilo-paginas.css">
		...
		<script type="text/javascript">
			...
			function mostraAlunos() {
				...
				xmlhttp.open("GET", "../Opcoes-do-sistema/remocao-aluno/PHJL-WEB-Procura-alunos.php?q=" + str + "&tipo=" + tipoInput + "&valorfiltro=" + valorFiltro + "&tipofiltro=" + tipoFiltro, true);
				xmlhttp.send();
			}
			...
			function retornaValores(inputid, valor, id){
				...
				xmlhttp.open("GET", "../Opcoes-do-sistema/remocao-aluno/PHJL-WEB-Retorna-valor-dos-selects-alteracao.php?valor=" + valor + "&id=" +id , true);
				xmlhttp.send();
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 ml-auto mr-auto">
							...
							<form class="contact-form" method = "POST" action = "../Opcoes-do-sistema/remocao-aluno/PHJL-WEB-Deletar-alunos.php" id="formulario">
								<div class = "row">
