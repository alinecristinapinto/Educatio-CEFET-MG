	...
	<nav class="navbar navbar-expand-md navbar-default">
        ...
        <div id="menu" class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="gerencia-web-interface-aluno-academico.php"><i class="nc-icon nc-book-bookmark"></i>Turmas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="gerencia-web-interface-aluno-biblioteca.php"><i class="nc-icon nc-book-bookmark"></i>Alunos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="gerencia-web-interface-aluno-biblioteca.php"><i class="nc-icon nc-book-bookmark"></i>Etapas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="gerencia-web-interface-aluno-biblioteca.php"><i class="nc-icon nc-book-bookmark"></i>Diários</a>
                </li>
            </ul>
