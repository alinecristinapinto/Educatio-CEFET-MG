...
//percorre tabela decarte e coloca os valores em array
	while($row = $result->fetch_assoc()){
		...
		$ativo=$row["ativo"];
		if($ativo!='N'){
		$valorRetornado .= "<tr onclick=\"enviaFormulario('" .$idAcervo."','" .$nomeacervo."')\" ><td>".$idAcervo."</td><td>".$nomeacervo."</td><td>".$tipoacervo."</td><td>".$localacervo."</td><td>".$editora."</td><td>".$ano."</td></tr>";
		}
	}
