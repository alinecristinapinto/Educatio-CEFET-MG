	...
	<body>
		...
		<?php
			if(RESULTADO == "inserirSUCESSO"){
				echo '
				<iframe height="1000" width="100%" src="FAGE-WEB-form.php"></iframe>
				...
				echo '
					<iframe height="1000" width="100%" class="TelaCheiaiframe" src="FAGE-WEB-form.php"></iframe>
				...
				echo '
					<iframe class="TelaCheiaiframe" src="FAGE-WEB-form.php"></iframe>
