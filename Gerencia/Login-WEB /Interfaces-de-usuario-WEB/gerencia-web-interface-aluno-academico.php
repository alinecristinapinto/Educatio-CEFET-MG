  ...
  <nav role="navigation" class="navbar navbar-default">        
        ...
        <div id="menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><span class="glyphicon glyphicon-book"></span> Diário</a>
                <li><a href="#"><span class="glyphicon glyphicon-folder-open"></span>  Boletim</a>
                <li><a href="#"><span class="glyphicon glyphicon-search"></span> Histórico</a>
                <li><a href="#"><span class="glyphicon glyphicon-print"></span> Certificado</a>
