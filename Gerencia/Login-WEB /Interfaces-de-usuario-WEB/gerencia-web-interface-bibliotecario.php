  ...
  <nav role="navigation" class="navbar navbar-default">        
        ...
        <div id="menu" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#"><span class="glyphicon glyphicon-pencil"></span> Cadastrar Acervo</a>
              ...
              <ul class="dropdown-menu">
                <li><a href="#">Vizualizar Empréstimos</a></li>
                <li class="divider"></li>
                <li><a href="#">Conceder Empréstimo</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-search"></span> Reservas</a>
              <ul class="dropdown-menu">
                <li><a href="#">Vizualizar Reservas</a></li>
                <li class="divider"></li>
                <li><a href="#">Conceder/Registrar Reserva</a></li>
              </ul>
            </li>
          </ul>    
