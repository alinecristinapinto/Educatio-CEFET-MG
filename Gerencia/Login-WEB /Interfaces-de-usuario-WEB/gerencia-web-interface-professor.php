  ...
  <nav role="navigation" class="navbar navbar-default">        
        ...
        <div id="menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><span class="glyphicon glyphicon-eye-open"></span> Vizualizar Turmas</a>
                <li><a href="#"><span class="glyphicon glyphicon-eye-open"></span>  Vizualizar Alunos</a>
                <li><a href="#"><span class="glyphicon glyphicon-list"></span>  Etapas</a>
                <li><a href="#"><span class="glyphicon glyphicon-file"></span>  Diário</a>	
           </ul>
