...
public class Relatorio8Dao {
	...
	public Relatorio8Aluno getAluno(String CPF) throws SQLException{
        ...
        System.out.println("MODALIDADE: "+modalidadeCurso);
        System.out.println("PRIMEIRO ANO: "+menor);
        System.out.println("ULTIMO ANO: "+maior);*/
	...
	public boolean testaRelatorio() throws SQLException{
        ...
        //NÃO CONSERTAR O ACENTRO DE TECNICO INTEGRADO, CASO ENTRE NA FUNÇÃO OCORRE ERRO
        if (modalidadeCurso.equals("Tecnico Integrado")){
            //Aluno Técnico
   ...
   //             System.out.println("Tamanho idConteudoAluno[i] = "+ idConteudoAluno[i]);
                ...
                for ( i = 0; i< idDisciplinas.size() ; i++){
                		int soma = (int) DoubleStream.of(notaConteudoAluno[i]).sum();
                		notaTotal.add(soma);
                }
            ...
            //    System.out.println("Nota total por disciplina = "+notaTotal+"\n\n\n");
                ...
                //NÃO CONSERTAR O ACENTRO DE GRADUACAO, CASO ENTRE NA FUNÇÃO OCORRE ERRO
        	if (modalidadeCurso.equals("Graduacao")){
                ...
                if(serieTurma!=3){
                    ...
                    int i = 0;
                    int j = 0;
                    int idConteudoAluno[][] = new int[50][50];
                    for (i = 0 ; i<idDisciplinas.size() ; i++){
                    ...
                    //Matriz a ser usada posteiormente
                    i=0 ; j = 0; int k = 0;
                    double notaConteudoAluno[][] = new double[50][50];
                    for (i=0 ; i<idDisciplinas.size() ; i++){
                    		for(j=0 ; j <idConteudoAluno.length ; j++){
