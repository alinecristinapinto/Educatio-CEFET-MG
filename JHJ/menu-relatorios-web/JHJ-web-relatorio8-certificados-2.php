<?php
    ...
    if (isset($_POST['opcaoMostrar'])) {
    	$strOpcaoEscolhida = "mostrarNaTela";
    	$_SESSION['opcaoEscolhida'] = $strOpcaoEscolhida;
	}
	if (isset($_POST['opcaoDownload'])) {
    	$strOpcaoEscolhida = "fazerDownload";
    	$_SESSION['opcaoEscolhida'] = $strOpcaoEscolhida;
	}
		...
		?>
			...
			<script language="javascript" type="text/javascript"> 
				function irParaPaginaCertificado(){
					location.href = "JHJ-web-relatorio8-certificados-3.php";
				}
		...
		?>
			<script type="text/javascript">
				...
				function voltarParaPaginaInicial(){
					location.href = "JHJ-web-relatorio8-certificados-1.php";
				}
			</script>
