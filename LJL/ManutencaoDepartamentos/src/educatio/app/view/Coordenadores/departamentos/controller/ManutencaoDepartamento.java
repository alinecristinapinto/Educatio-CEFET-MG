...
import educatio.app.view.Coordenadores.departamentos.controller.model.Departamento;
import educatio.app.view.Coordenadores.departamentos.controller.jdbc.Conexão;
import java.sql.*;
...
public class ManutencaoDepartamento {
    ...
    private boolean handleFuncionarioSubordinado(int idDepto) throws SQLException {
        ...
        if (flag == true) {
            ...
            getClass().getResource("view/Padrao.css").toExternalForm());
