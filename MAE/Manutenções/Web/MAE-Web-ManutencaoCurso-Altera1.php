                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <form class="contact-form" action="MAE-Web-ManutencaoCurso-Altera2.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 ml-auto mr-auto">
                                        <button type="submit" id="botaoExcluirCurso" class="btn btn-info btn-round">Alterar curso</button>
                                    </div>
