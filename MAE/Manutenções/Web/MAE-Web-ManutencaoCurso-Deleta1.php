...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $query = mysqli_query($link, " SELECT id, idDepto, nome, horasTotal, modalidade FROM cursos WHERE ativo='S' ORDER BY nome ASC");
        ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <form class="contact-form" action="MAE-Web-ManutencaoCurso-Deleta2.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 ml-auto mr-auto">
                                        <button type="button" id="botaoExcluirCurso" class="btn btn-info btn-round">Excluir curso</button>
                                    </div>
