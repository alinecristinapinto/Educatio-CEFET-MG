      ...
      <div class="container">
        <div class="row">
          ...
          <!--select com os nomes das turma -->
            <form class="contact-form" action="MAE-Web-ManutencaoTurmas-Excluir.php" method="post" >
              ...
              <div class="col-md-4 ml-auto mr-auto">
                  <button type="submit" id="botaoExcluirCurso" class="btn btn-info btn-round">Excluir turma</button>
              </div>
