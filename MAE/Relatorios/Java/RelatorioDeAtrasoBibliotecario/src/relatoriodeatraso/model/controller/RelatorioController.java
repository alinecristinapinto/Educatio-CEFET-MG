...
public class RelatorioController implements Initializable {
    ...
    ObservableList<Atrasos> lista = FXCollections.observableArrayList();
    @FXML
    ...
    public void mostrarRelatorio() throws SQLException, ParseException {
       ...
       if(!aluno.equals("todos")){
            ...
            resultado = selecionarRegistros("emprestimos", "idAluno", resultadoAluno.getString("idCPF"));
        }
        else{
            resultado = selecionarRegistros("emprestimos");
        }
        ...
        do {
            ...
            if (atraso) {
                ...
                ResultSet resultadoAluno = selecionarRegistros("alunos", "idCPF", resultado.getString("idAluno"));
                lista.add(new Atrasos(resultadoAluno.getString("nome"), stringPrevisaoDevolucao, stringDevolucao, String.format("%.0f", diferencaDias) ));
