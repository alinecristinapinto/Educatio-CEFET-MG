...
public class BlocoDiarioAlunoControlador {
    ...
    @FXML
    private TableView<TabelaFrequencia> DiarioTabelaF;
    @FXML
    private TableColumn<TabelaFrequencia, String> colunaDataF;
    @FXML
    private TableColumn<TabelaFrequencia, String> colunaFaltaF;
    ...
    public void initialize() {
        ...
        colunaDataF.setCellValueFactory(cellData -> cellData.getValue().getData());
        colunaFaltaF.setCellValueFactory(cellData -> cellData.getValue().getFalta());
 
    }
    public void colocaDadosAtividades()
    {
        DiarioTabela.setItems(acesso.getDadosAtividade());
    }
     public void colocaDadosFrequencia()
    {
        DiarioTabelaF.setItems(acesso.getDadosFrequencia());
    }
