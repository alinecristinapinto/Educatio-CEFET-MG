function lancaPresencaBD(alunos){
	
	//a seguir é criada uma string que passará alguns dados pela url.
	//ao final a string será parecida com : "PHJL-WEB-Lancar-presenca-no-BD.php?ID89594318180=1&ID13612887106=2",
	//sendo o número que vem depois de "ID" igual ao idCPF do aluno, e o número que vem depois do "=" igual ao
	//valor digitado nos inputs de falta, logo é o valor da falta deste aluno.
	//No exemplo acima, a aluna Isabele, cujo cpf é 89594318180 recebeu 1 falta na atividade escolhida,
	//e a aluna Clarisse, cujo cpf é 13612887106 recebeu 2 faltas na atividade escolhida
	var url = "PHJL-WEB-Lancar-presenca-no-BD.php?";
	...
	xmlhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			//this.responseText é o valor retornado pela pagina "PHJL-WEB-Lancar-presenca-no-BD.php"
			///*
