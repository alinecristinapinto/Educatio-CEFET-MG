...
<html>
	<head>
		...
		<title> Altera&#231;&atilde;o de aluno </title>
                                        ...
                                        <?php
											...
											while($linhaTurma2 = mysqli_fetch_array($result)){
												if($linhaTurma2[0] == $linhaTurma[0]){
													echo "<option value = " .$linhaTurma2[0] ." selected>" .$linhaTurma2[3] ."</option>";
												}else{
													echo "<option value = " .$linhaTurma2[0] .">" .$linhaTurma2[3] ."</option>";
												}
											}
										?>
									</select>
