...
###############################################################################################
	...
	####################################################
		...
		$idEtapa = 1;
		$idDisciplina = 1;
		$conteudo = "Conteúdo 1 de Geografia 1º Bim";
		$datas = "20/02/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 2
		$idEtapa = 1;
		$idDisciplina = 2;
		$conteudo = "Conteúdo 1 de História 1º Bim";
		$datas = "20/02/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 3
		$idEtapa = 5;
		$idDisciplina = 3;
		$conteudo = "Conteúdo 1 de Filosofia 1º Sem";
		$datas = "21/02/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 4
		$idEtapa = 5;
		$idDisciplina = 4;
		$conteudo = "Conteúdo 1 de Socio. 1º Sem";
		$datas = "21/02/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 5
		...
		$idEtapa = 1;
		$idDisciplina = 8;
		$conteudo = "Conteúdo 1 de Materiais 1º Bim";
		$datas = "23/02/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 9
		$idEtapa = 2;
		$idDisciplina = 1;
		$conteudo = "Conteúdo 1 de Geografia 2º Bim";
		$datas = "08/05/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 10
		$idEtapa = 2;
		$idDisciplina = 2;
		$conteudo = "Conteúdo 1 de História 2º Bim";
		$datas = "08/05/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 11
		$idEtapa = 6;
		$idDisciplina = 3;
		$conteudo = "Conteúdo 1 de Filosofia 2º Sem";
		$datas = "09/05/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 12
		$idEtapa = 6;
		$idDisciplina = 4;
		$conteudo = "Conteúdo 1 de Socio. 2º Sem";
		$datas = "09/05/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 13
		...
		$idEtapa = 2;
		$idDisciplina = 8;
		$conteudo = "Conteúdo 1 de Materiais 2º Bim";
		$datas = "11/05/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 17
		$idEtapa = 3;
		$idDisciplina = 1;
		$conteudo = "Conteúdo 1 de Geografia 3º Bim";
		$datas = "07/08/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 18
		$idEtapa = 3;
		$idDisciplina = 2;
		$conteudo = "Conteúdo 1 de História 3º Bim";
		$datas = "07/08/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 19
		...
		$idEtapa = 3;
		$idDisciplina = 8;
		$conteudo = "Conteúdo 1 de Materiais 3º Bim";
		$datas = "10/08/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 23
		$idEtapa = 4;
		$idDisciplina = 1;
		$conteudo = "Conteúdo 1 de Geografia 4º Bim";
		$datas = "02/10/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 24
		$idEtapa = 4;
		$idDisciplina = 2;
		$conteudo = "Conteúdo 1 de História 4º Bim";
		$datas = "02/10/2017";
		$ativo = "S";
		$stmt -> execute();
		// idConteudo 25
		...
		$idEtapa = 4;
		$idDisciplina = 8;
		$conteudo = "Conteúdo 1 de Materiais 4º Bim";
		$datas = "05/10/2017";
		$ativo = "S";
		$stmt -> execute();
	####################################################
